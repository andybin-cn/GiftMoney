...
class WordAnalyzeHelp {
    ...
    func isGiftUnit(word: String) -> Bool {
        return giftUnits.findFirst(predicate: { (name) -> Bool in
            return word.contains(name)
        }) != nil
    }
    func isMoneyUnit(word: String) -> Bool {
        return moneyUnits.findFirst(predicate: { (name) -> Bool in
            return word.contains(name)
        }) != nil
    }
    ...
    func isGiftNameWords(word: String) -> Bool {
        return giftNames.findFirst(predicate: { (name) -> Bool in
            return word.contains(name)
        }) != nil
    }
    func isInAccountWords(word: String) -> Bool {
        ...
        return ["收到", "收了", "送来"].findFirst(predicate: { (name) -> Bool in
            return word.contains(name)
        }) != nil
    }
    func isOutAccountWords(word: String) -> Bool {
        ...
        return ["送出", "送给", "发给", "发了", "给了"].findFirst(predicate: { (name) -> Bool in
            return word.contains(name)
        }) != nil
    }
    ...
    func isMoneyValue(word: String) -> Bool {
        let predicate = NSPredicate(format: "SELF MATCHES %@", "^([0-9]+|[0-9]{1,3}(,[0-9]{3})*)(.[0-9]{0,2})?$")
        return predicate.evaluate(with: word)
    }
}
